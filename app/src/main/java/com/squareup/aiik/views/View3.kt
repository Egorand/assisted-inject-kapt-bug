...
import com.squareup.aiik.presenters.Presenter3 as Presenter
...
class View3 @InflationInject constructor(
  ...
  override fun onAttachedToWindow() {
    ...
    disposables.add(
        viewEvents
            .compose(factory.create(viewTitle = "View 3"))
            .observeOn(AndroidSchedulers.mainThread())
            .subscribe(this::render)
    )

    setOnClickListener {
      viewEvents.accept(ChangeTitle(newTitle = "New View 3"))
    }
  }
