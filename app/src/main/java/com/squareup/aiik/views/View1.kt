...
import com.squareup.aiik.presenters.Presenter1 as Presenter
...
class View1 @InflationInject constructor(
  ...
  override fun onAttachedToWindow() {
    ...
    disposables.add(
        viewEvents
            .compose(factory.create(viewTitle = "View 1"))
            .observeOn(AndroidSchedulers.mainThread())
            .subscribe(this::render)
    )

    setOnClickListener {
      viewEvents.accept(ChangeTitle(newTitle = "New View 1"))
    }
  }
